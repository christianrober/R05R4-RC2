/*
 * $Id: aug_sysdep.h,v 1.1 2005/07/25 05:52:06 magicyang Exp $
 *
...
**                     $Revision: 1.1 $
**
**             Last change $Date: 2005/07/25 05:52:06 $
**           Last change $Author: magicyang $
**                        $State: Exp $
**                       $Locker:  $
**
...
error: os/cpu/compiler combination not configured in $Source: /cvsroot/uclinux533/uClinux-dist/user/ser/modules/postgres/aug_sysdep.h,v $ $Revision: 1.1 $
#endif
