...
gint linphone_core_preview_ring(LinphoneCore *lc, const gchar *ring,LinphoneCoreCbFunc func,gpointer userdata)
{
  ...
  lc->ringstream=ring_start_with_cb((char*)ring,2,snd_card_manager_get_card(snd_card_manager,lc->sound_conf.play_sndcard),(MSFilterNotifyFunc)notify_end_of_ring,(gpointer)lc);
  return 0;
}
