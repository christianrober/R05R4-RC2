...
create_app1 (void)
{
  ...
  addressentry = gnome_entry_new ("hostnames");
  gtk_widget_show (addressentry);
  gtk_container_add (GTK_CONTAINER (frame7), addressentry);

  entry4 = gnome_entry_gtk_entry (GNOME_ENTRY (addressentry));
  gtk_widget_show (entry4);
  gtk_tooltips_set_tip (tooltips, entry4, _("Type here the sip address of the person you want to call."), NULL);
  gtk_entry_set_text (GTK_ENTRY (entry4), _("sip:"));
