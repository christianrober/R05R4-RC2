 ...
 *------------------------------------------------------------------
 *
 * $Source: /cvsroot/uclinux533/uClinux-dist/user/e2fsprogs/lib/ss/test_ss.c,v $
 * $Revision: 1.2 $
 * $Date: 2005/07/25 02:00:44 $
 * $State: Exp $
 * $Author: magicyang $
 * $Locker:  $
 *
...
static char const rcsid_test_c[] =
    "$Header: /cvsroot/uclinux533/uClinux-dist/user/e2fsprogs/lib/ss/test_ss.c,v 1.2 2005/07/25 02:00:44 magicyang Exp $";
#endif /* lint */
