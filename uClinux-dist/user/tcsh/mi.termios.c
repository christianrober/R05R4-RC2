/* $Header: /cvsroot/uclinux533/uClinux-dist/user/tcsh/mi.termios.c,v 1.2 2005/07/25 06:42:15 magicyang Exp $ */
/* termios.c - fake termios interface using sgtty interface 
 * 	       by Magnus Doell and Bruce Evans.
 *
 */
#include "sh.h"
RCSID("$Id: mi.termios.c,v 1.2 2005/07/25 06:42:15 magicyang Exp $")
