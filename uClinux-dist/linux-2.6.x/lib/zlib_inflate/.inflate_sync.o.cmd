cmd_lib/zlib_inflate/inflate_sync.o := bfin-uclinux-gcc -Wp,-MD,lib/zlib_inflate/.inflate_sync.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=inflate_sync -DKBUILD_MODNAME=zlib_inflate -c -o lib/zlib_inflate/inflate_sync.o lib/zlib_inflate/inflate_sync.c
