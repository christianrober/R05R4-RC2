cmd_fs/read_write.o := bfin-uclinux-gcc -Wp,-MD,fs/.read_write.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=read_write -DKBUILD_MODNAME=read_write -c -o fs/read_write.o fs/read_write.c
