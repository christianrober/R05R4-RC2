cmd_fs/proc/proc_tty.o := bfin-uclinux-gcc -Wp,-MD,fs/proc/.proc_tty.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=proc_tty -DKBUILD_MODNAME=proc -c -o fs/proc/proc_tty.o fs/proc/proc_tty.c
