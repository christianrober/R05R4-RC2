cmd_fs/char_dev.o := bfin-uclinux-gcc -Wp,-MD,fs/.char_dev.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=char_dev -DKBUILD_MODNAME=char_dev -c -o fs/char_dev.o fs/char_dev.c
