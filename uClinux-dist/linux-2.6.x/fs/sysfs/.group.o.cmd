cmd_fs/sysfs/group.o := bfin-uclinux-gcc -Wp,-MD,fs/sysfs/.group.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=group -DKBUILD_MODNAME=group -c -o fs/sysfs/group.o fs/sysfs/group.c
