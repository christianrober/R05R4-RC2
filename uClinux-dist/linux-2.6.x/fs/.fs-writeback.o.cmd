cmd_fs/fs-writeback.o := bfin-uclinux-gcc -Wp,-MD,fs/.fs-writeback.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=fs_writeback -DKBUILD_MODNAME=fs_writeback -c -o fs/fs-writeback.o fs/fs-writeback.c
