cmd_kernel/sched.o := bfin-uclinux-gcc -Wp,-MD,kernel/.sched.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement    -fno-omit-frame-pointer  -DKBUILD_BASENAME=sched -DKBUILD_MODNAME=sched -c -o kernel/sched.o kernel/sched.c
