cmd_kernel/posix-cpu-timers.o := bfin-uclinux-gcc -Wp,-MD,kernel/.posix-cpu-timers.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=posix_cpu_timers -DKBUILD_MODNAME=posix_cpu_timers -c -o kernel/posix-cpu-timers.o kernel/posix-cpu-timers.c
