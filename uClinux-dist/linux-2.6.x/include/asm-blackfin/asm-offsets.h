 ...
 * DO NOT MODIFY.
 *
 * This file was generated by arch/blackfin/Makefile
 *
 */
...
#define TASK_BLOCKED 484 /* offsetof(struct task_struct, blocked) */
...
#define TASK_MM 116 /* offsetof(struct task_struct, mm) */
#define TASK_ACTIVE_MM 120 /* offsetof(struct task_struct, active_mm) */
#define TASK_SIGPENDING 500 /* offsetof(struct task_struct, pending) */
...
#define KERNEL_STACK_SIZE 8192 /* THREAD_SIZE */
#define PT_ORIG_P0 212 /* offsetof(struct pt_regs, orig_p0) */
#define PT_ORIG_PC 0 /* offsetof(struct pt_regs, orig_pc) */
...
#define PT_L0 108 /* offsetof(struct pt_regs, l0) */
#define PT_L1 104 /* offsetof(struct pt_regs, l1) */
#define PT_L2 100 /* offsetof(struct pt_regs, l2) */
#define PT_L3 96 /* offsetof(struct pt_regs, l3) */
...
#define PT_SYSCFG 216 /* offsetof(struct pt_regs, syscfg) */
#define PT_IPEND 4 /* offsetof(struct pt_regs, ipend) */
#define SIZEOF_PTREGS 220 /* sizeof(struct pt_regs) */
#define PT_EXTRA1 220 /* sizeof(struct pt_regs) */
#define PT_EXTRA2 224 /* 4 + sizeof(struct pt_regs) */
#define PT_EXTRA3 228 /* 8 + sizeof(struct pt_regs) */
