cmd_mm/page_alloc.o := bfin-uclinux-gcc -Wp,-MD,mm/.page_alloc.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=page_alloc -DKBUILD_MODNAME=page_alloc -c -o mm/page_alloc.o mm/page_alloc.c
