cmd_drivers/char/blackfin_rtc.o := bfin-uclinux-gcc -Wp,-MD,drivers/char/.blackfin_rtc.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=blackfin_rtc -DKBUILD_MODNAME=blackfin_rtc -c -o drivers/char/blackfin_rtc.o drivers/char/blackfin_rtc.c

deps_drivers/char/blackfin_rtc.o := \
  drivers/char/blackfin_rtc.c \
  ...
  drivers/char/blackfin_rtc.h \

drivers/char/blackfin_rtc.o: $(deps_drivers/char/blackfin_rtc.o)
