cmd_drivers/char/tty_io.o := bfin-uclinux-gcc -Wp,-MD,drivers/char/.tty_io.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=tty_io -DKBUILD_MODNAME=tty_io -c -o drivers/char/tty_io.o drivers/char/tty_io.c
