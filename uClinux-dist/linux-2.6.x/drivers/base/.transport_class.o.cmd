cmd_drivers/base/transport_class.o := bfin-uclinux-gcc -Wp,-MD,drivers/base/.transport_class.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=transport_class -DKBUILD_MODNAME=transport_class -c -o drivers/base/transport_class.o drivers/base/transport_class.c
