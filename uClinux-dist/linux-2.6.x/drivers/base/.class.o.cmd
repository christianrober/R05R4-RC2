cmd_drivers/base/class.o := bfin-uclinux-gcc -Wp,-MD,drivers/base/.class.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=class -DKBUILD_MODNAME=class -c -o drivers/base/class.o drivers/base/class.c
