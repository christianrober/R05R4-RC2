 ...
 *
 *  $Id: 8250.c,v 1.4 2005/08/12 06:43:02 magicyang Exp $
 *
...
static int __init serial8250_init(void)
{
	...
	printk(KERN_INFO "Serial: 8250/16550 driver $Revision: 1.4 $ "
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Generic 8250/16x50 serial driver $Revision: 1.4 $");
