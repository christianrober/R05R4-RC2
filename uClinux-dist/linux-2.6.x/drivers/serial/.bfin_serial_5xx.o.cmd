cmd_drivers/serial/bfin_serial_5xx.o := bfin-uclinux-gcc -Wp,-MD,drivers/serial/.bfin_serial_5xx.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=bfin_serial_5xx -DKBUILD_MODNAME=bfin_serial_5xx -c -o drivers/serial/bfin_serial_5xx.o drivers/serial/bfin_serial_5xx.c

deps_drivers/serial/bfin_serial_5xx.o := \
  drivers/serial/bfin_serial_5xx.c \
    $(wildcard include/config/serial/blackfin/dma.h) \
  ...
  include/asm/dpmc.h \
  drivers/serial/bfin_serial_5xx.h \

drivers/serial/bfin_serial_5xx.o: $(deps_drivers/serial/bfin_serial_5xx.o)
