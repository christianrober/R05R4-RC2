cmd_drivers/mtd/chips/stm_mw320db.o := bfin-uclinux-gcc -Wp,-MD,drivers/mtd/chips/.stm_mw320db.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=stm_mw320db -DKBUILD_MODNAME=stm_mw320db -c -o drivers/mtd/chips/stm_mw320db.o drivers/mtd/chips/stm_mw320db.c

deps_drivers/mtd/chips/stm_mw320db.o := \
  drivers/mtd/chips/stm_mw320db.c \
...
drivers/mtd/chips/stm_mw320db.o: $(deps_drivers/mtd/chips/stm_mw320db.o)
