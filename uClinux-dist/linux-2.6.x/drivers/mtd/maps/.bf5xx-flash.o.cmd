cmd_drivers/mtd/maps/bf5xx-flash.o := bfin-uclinux-gcc -Wp,-MD,drivers/mtd/maps/.bf5xx-flash.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=bf5xx_flash -DKBUILD_MODNAME=bf5xx_flash -c -o drivers/mtd/maps/bf5xx-flash.o drivers/mtd/maps/bf5xx-flash.c

deps_drivers/mtd/maps/bf5xx-flash.o := \
  drivers/mtd/maps/bf5xx-flash.c \
    $(wildcard include/config/bfin.h) \
    $(wildcard include/config/bfin/flash/bank/1.h) \
    $(wildcard include/config/bfin/flash/bank/0.h) \
    $(wildcard include/config/bfin/flash/bank/3.h) \
    $(wildcard include/config/bfin/flash/bank/2.h) \
    $(wildcard include/config/bfin/shared/flash/enet.h) \
    $(wildcard include/config/enet/flash/pin.h) \
    $(wildcard include/config/ebiu/flash/base.h) \
    $(wildcard include/config/bfin/flash/size.h) \
...
drivers/mtd/maps/bf5xx-flash.o: $(deps_drivers/mtd/maps/bf5xx-flash.o)
