cmd_net/ipv4/ip_output.o := bfin-uclinux-gcc -Wp,-MD,net/ipv4/.ip_output.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=ip_output -DKBUILD_MODNAME=ip_output -c -o net/ipv4/ip_output.o net/ipv4/ip_output.c
