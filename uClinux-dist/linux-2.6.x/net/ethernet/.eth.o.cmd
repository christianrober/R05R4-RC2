cmd_net/ethernet/eth.o := bfin-uclinux-gcc -Wp,-MD,net/ethernet/.eth.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=eth -DKBUILD_MODNAME=eth -c -o net/ethernet/eth.o net/ethernet/eth.c
