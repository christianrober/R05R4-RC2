cmd_arch/blackfin/kernel/bfin_ksyms.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/kernel/.bfin_ksyms.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=bfin_ksyms -DKBUILD_MODNAME=bfin_ksyms -c -o arch/blackfin/kernel/bfin_ksyms.o arch/blackfin/kernel/bfin_ksyms.c

deps_arch/blackfin/kernel/bfin_ksyms.o := \
...
arch/blackfin/kernel/bfin_ksyms.o: $(deps_arch/blackfin/kernel/bfin_ksyms.o)
