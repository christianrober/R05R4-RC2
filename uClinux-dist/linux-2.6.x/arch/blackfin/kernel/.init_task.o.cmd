cmd_arch/blackfin/kernel/init_task.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/kernel/.init_task.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=init_task -DKBUILD_MODNAME=init_task -c -o arch/blackfin/kernel/init_task.o arch/blackfin/kernel/init_task.c

deps_arch/blackfin/kernel/init_task.o := \
...
arch/blackfin/kernel/init_task.o: $(deps_arch/blackfin/kernel/init_task.o)
