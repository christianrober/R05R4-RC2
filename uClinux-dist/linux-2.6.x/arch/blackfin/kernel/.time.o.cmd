cmd_arch/blackfin/kernel/time.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/kernel/.time.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=time -DKBUILD_MODNAME=time -c -o arch/blackfin/kernel/time.o arch/blackfin/kernel/time.c

deps_arch/blackfin/kernel/time.o := \
...
arch/blackfin/kernel/time.o: $(deps_arch/blackfin/kernel/time.o)
