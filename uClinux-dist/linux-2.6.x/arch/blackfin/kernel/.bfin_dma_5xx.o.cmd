cmd_arch/blackfin/kernel/bfin_dma_5xx.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/kernel/.bfin_dma_5xx.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=bfin_dma_5xx -DKBUILD_MODNAME=bfin_dma_5xx -c -o arch/blackfin/kernel/bfin_dma_5xx.o arch/blackfin/kernel/bfin_dma_5xx.c

deps_arch/blackfin/kernel/bfin_dma_5xx.o := \
...
arch/blackfin/kernel/bfin_dma_5xx.o: $(deps_arch/blackfin/kernel/bfin_dma_5xx.o)
