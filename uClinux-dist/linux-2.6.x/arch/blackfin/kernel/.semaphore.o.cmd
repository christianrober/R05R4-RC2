cmd_arch/blackfin/kernel/semaphore.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/kernel/.semaphore.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=semaphore -DKBUILD_MODNAME=semaphore -c -o arch/blackfin/kernel/semaphore.o arch/blackfin/kernel/semaphore.c

deps_arch/blackfin/kernel/semaphore.o := \
  arch/blackfin/kernel/semaphore.c \
...
arch/blackfin/kernel/semaphore.o: $(deps_arch/blackfin/kernel/semaphore.o)
