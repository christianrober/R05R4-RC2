cmd_arch/blackfin/kernel/traps.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/kernel/.traps.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=traps -DKBUILD_MODNAME=traps -c -o arch/blackfin/kernel/traps.o arch/blackfin/kernel/traps.c

deps_arch/blackfin/kernel/traps.o := \
...
arch/blackfin/kernel/traps.o: $(deps_arch/blackfin/kernel/traps.o)
