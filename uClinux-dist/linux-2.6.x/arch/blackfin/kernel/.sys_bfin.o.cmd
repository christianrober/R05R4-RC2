cmd_arch/blackfin/kernel/sys_bfin.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/kernel/.sys_bfin.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=sys_bfin -DKBUILD_MODNAME=sys_bfin -c -o arch/blackfin/kernel/sys_bfin.o arch/blackfin/kernel/sys_bfin.c

deps_arch/blackfin/kernel/sys_bfin.o := \
...
arch/blackfin/kernel/sys_bfin.o: $(deps_arch/blackfin/kernel/sys_bfin.o)
