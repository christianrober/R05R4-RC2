cmd_arch/blackfin/kernel/dma-mapping.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/kernel/.dma-mapping.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=dma_mapping -DKBUILD_MODNAME=dma_mapping -c -o arch/blackfin/kernel/dma-mapping.o arch/blackfin/kernel/dma-mapping.c

deps_arch/blackfin/kernel/dma-mapping.o := \
...
arch/blackfin/kernel/dma-mapping.o: $(deps_arch/blackfin/kernel/dma-mapping.o)
