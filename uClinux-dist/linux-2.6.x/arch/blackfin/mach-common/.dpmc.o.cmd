cmd_arch/blackfin/mach-common/dpmc.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/mach-common/.dpmc.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -D__ASSEMBLY__    -c -o arch/blackfin/mach-common/dpmc.o arch/blackfin/mach-common/dpmc.S

deps_arch/blackfin/mach-common/dpmc.o := \
...
arch/blackfin/mach-common/dpmc.o: $(deps_arch/blackfin/mach-common/dpmc.o)
