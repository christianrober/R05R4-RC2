cmd_arch/blackfin/mach-common/cache.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/mach-common/.cache.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -D__ASSEMBLY__    -c -o arch/blackfin/mach-common/cache.o arch/blackfin/mach-common/cache.S

deps_arch/blackfin/mach-common/cache.o := \
...
arch/blackfin/mach-common/cache.o: $(deps_arch/blackfin/mach-common/cache.o)
