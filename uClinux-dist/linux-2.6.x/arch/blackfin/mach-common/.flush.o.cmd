cmd_arch/blackfin/mach-common/flush.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/mach-common/.flush.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -D__ASSEMBLY__    -c -o arch/blackfin/mach-common/flush.o arch/blackfin/mach-common/flush.S

deps_arch/blackfin/mach-common/flush.o := \
  arch/blackfin/mach-common/flush.S \
...
arch/blackfin/mach-common/flush.o: $(deps_arch/blackfin/mach-common/flush.o)
