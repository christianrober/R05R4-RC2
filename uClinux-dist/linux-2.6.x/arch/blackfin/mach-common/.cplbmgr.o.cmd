cmd_arch/blackfin/mach-common/cplbmgr.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/mach-common/.cplbmgr.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -D__ASSEMBLY__    -c -o arch/blackfin/mach-common/cplbmgr.o arch/blackfin/mach-common/cplbmgr.S

deps_arch/blackfin/mach-common/cplbmgr.o := \
...
arch/blackfin/mach-common/cplbmgr.o: $(deps_arch/blackfin/mach-common/cplbmgr.o)
