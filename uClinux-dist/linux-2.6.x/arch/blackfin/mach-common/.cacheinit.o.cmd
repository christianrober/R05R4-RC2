cmd_arch/blackfin/mach-common/cacheinit.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/mach-common/.cacheinit.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -D__ASSEMBLY__    -c -o arch/blackfin/mach-common/cacheinit.o arch/blackfin/mach-common/cacheinit.S

deps_arch/blackfin/mach-common/cacheinit.o := \
  ...
  include/asm/cplbtab.h \
    $(wildcard include/config/cplb/info.h) \

arch/blackfin/mach-common/cacheinit.o: $(deps_arch/blackfin/mach-common/cacheinit.o)
