cmd_arch/blackfin/lib/checksum.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/lib/.checksum.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=checksum -DKBUILD_MODNAME=checksum -c -o arch/blackfin/lib/checksum.o arch/blackfin/lib/checksum.c

deps_arch/blackfin/lib/checksum.o := \
...
arch/blackfin/lib/checksum.o: $(deps_arch/blackfin/lib/checksum.o)
