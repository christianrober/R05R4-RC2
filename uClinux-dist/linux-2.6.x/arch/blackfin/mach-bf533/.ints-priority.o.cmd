cmd_arch/blackfin/mach-bf533/ints-priority.o := bfin-uclinux-gcc -Wp,-MD,arch/blackfin/mach-bf533/.ints-priority.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/3.4.4/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -fno-builtin -D__linux__ -Wdeclaration-after-statement     -DKBUILD_BASENAME=ints_priority -DKBUILD_MODNAME=ints_priority -c -o arch/blackfin/mach-bf533/ints-priority.o arch/blackfin/mach-bf533/ints-priority.c

deps_arch/blackfin/mach-bf533/ints-priority.o := \
  arch/blackfin/mach-bf533/ints-priority.c \
    $(wildcard include/config/pllwake/error.h) \
    $(wildcard include/config/dma/error.h) \
    $(wildcard include/config/ppi/error.h) \
    $(wildcard include/config/sport0/error.h) \
    $(wildcard include/config/spi/error.h) \
    $(wildcard include/config/sport1/error.h) \
    $(wildcard include/config/uart/error.h) \
    $(wildcard include/config/rtc/error.h) \
    $(wildcard include/config/dma0/ppi.h) \
    $(wildcard include/config/dma1/sport0rx.h) \
    $(wildcard include/config/dma2/sport0tx.h) \
    $(wildcard include/config/dma3/sport1rx.h) \
    $(wildcard include/config/dma4/sport1tx.h) \
    $(wildcard include/config/dma5/spi.h) \
    $(wildcard include/config/dma6/uartrx.h) \
    $(wildcard include/config/dma7/uarttx.h) \
    $(wildcard include/config/timer0.h) \
    $(wildcard include/config/timer1.h) \
    $(wildcard include/config/timer2.h) \
    $(wildcard include/config/pfa.h) \
    $(wildcard include/config/pfb.h) \
    $(wildcard include/config/memdma0.h) \
    $(wildcard include/config/memdma1.h) \
    $(wildcard include/config/wdtimer.h) \
...
arch/blackfin/mach-bf533/ints-priority.o: $(deps_arch/blackfin/mach-bf533/ints-priority.o)
